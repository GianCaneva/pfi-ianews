...
public class ComparisonAlgorithmTest extends TestCase {
    ...
    public void testWithProdInfo(){
        ...
        List<String> keywords1 = new LinkedList<String>(Arrays.asList("AMERICA", "LATINA", "FALTA", "OPORTUNIDADES", "SATISFACCION"));
        List<String> keywords2 = new LinkedList<String>(Arrays.asList("PROYECTOS","TURISMO","SUSPENSION","REORGANIZACION","SECRETARIAS"));
        List<String> keywords3 = new LinkedList<String>(Arrays.asList("POPULAR","LIBERALISMO","PERONISMO"));
        List<String> keywords4 = new LinkedList<String>(Arrays.asList("ARGENTINAS","FMI","DEVALUACION","INCERTIDUMBRE","CAMBIO"));
        List<String> keywords5 = new LinkedList<String>(Arrays.asList("BLUE","EURO","OFICIAL","DOLAR","OFICIAL"));
        List<String> keywords6 = new LinkedList<String>(Arrays.asList("VIOLENCIA","EXTREMA","DERECHA"));
        List<String> keywords7 = new LinkedList<String>(Arrays.asList("NUEVA","CEPA","SUBVARIANTE","EG5","VARIANTE"));
        List<String> keywords8 = new LinkedList<String>(Arrays.asList("CAMBIO","DE","CICLO","CICLO","INVERSORES"));
        List<String> keywords9 = new LinkedList<String>(Arrays.asList("PLANES","DE","FINANCIACION"));
        List<String> keywords10 = new LinkedList<String>(Arrays.asList("DE","AZAR","NUMEROS","DE","LOTERIA"));
        List<String> keywords11 = new LinkedList<String>(Arrays.asList("ACCIONES","MERCADOS","GALICIA","YPF","DESEMBOLSO"));
        List<String> keywords12 = new LinkedList<String>(Arrays.asList("MERCADO","DE","TRABAJO","INCERTIDUMBRE","HABILIDADES"));
        List<String> keywords13 = new LinkedList<String>(Arrays.asList("EDUCACION","PRIVADA","OBLIGATORIEDAD","GRATUIDAD","ESTADO"));
        List<String> keywords14 = new LinkedList<String>(Arrays.asList("MEDIOS","INTERNACIONALES"));
        List<String> keywords15 = new LinkedList<String>(Arrays.asList("GOBERNADOR","PERONISMO","LIBERTAD","AVANZA","JUNTOS"));
        List<String> keywords16 = new LinkedList<String>(Arrays.asList("NUEVA","YORK","MERCADO","LABORAL","DESEMPLEO"));
        List<String> keywords17 = new LinkedList<String>(Arrays.asList("SEGURIDAD","ANIBAL","FERNANDEZ"));
        List<String> keywords18 = new LinkedList<String>(Arrays.asList("DOLAR","MEP","FMI","DOLAR","BLUE"));
        List<String> keywords19 = new LinkedList<String>(Arrays.asList("SEGURIDAD","ANIBAL","FERNANDEZ"));
        List<String> keywords20 = new LinkedList<String>(Arrays.asList("DOLAR","MEP","FMI","DOLAR","BLUE"));
        List<String> keywords21 = new LinkedList<String>(Arrays.asList("AEROPARQUE","VUELOS","DEMORAS"));
        List<String> keywords22 = new LinkedList<String>(Arrays.asList("AMERICA","LATINA","FALTA","OPORTUNIDADES","SATISFACCION"));
        ...
        List<News> allNews= new LinkedList<News>(Arrays.asList(news1, news2, news3, news4, news5, news6, news7, news8, news9, news10, news11, news12, news13, news14, news15, news16, news17, news18, news19, news20, news21, news22));
